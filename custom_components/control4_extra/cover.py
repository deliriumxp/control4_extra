...
#
# Difference from upstream: covers ticked as dry-contact in the options flow report
# `assumed_state`, so the HA frontend never disables open/close from their
# (unreliable) status - `canOpen`/`canClose` in home-assistant/frontend's
